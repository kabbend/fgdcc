...
local critT = {
	...
	["U"] = {
		...
		{ r1 = 4, r2 = 4, text = "The horrifying visage of life after death infects the PC s thoughts as the un-dead leers into his eyes with its at- tack. The PC must make a DC 15 Fort save or be shaken and unable to move or attack for the next 1d4 rounds" },
		{ r1 = 5, r2 = 5, text = "The character is cursed from beyond the grave! Depending on his actions and the intelligence of the un- dead creature, the curse may have speci c terms associated with the wishes of the un-dead (judge s discre- tion; see Appendix C). Alternately, the curse causes a -1 penalty to Luck and all dice rolls until lifted." },
		...
		{ r1 = 7, r2 = 7, text = "Supernatural frost spreads out from the wound in a lacy web, causing an additional 1d8 damage and in- tense pain. The frost dissipates on the next round but until the next full moon, the PC takes an extra 1 point of damage from all cold-based attacks." },
		...
		{ r1 = 9, r2 = 9, text = "Faced with the very real prospect of unnatural un-death, the PC becomes unhinged. He immediately loses 1d4 Personality and goes temporarily insane, behaving erratically and strangely until the next new moon. The controlling player must make a percentile roll before any action, and on 01-10 the character makes an in- sane action (as determined by the judge) instead of what was intended. On 11-00 the intended action occurs." },
		...
		{ r1 = 18, r2 = 18, text = "The blow smashes against the PC s temple and gives him a glimpse of his own death sometime in the fu- ture. This brush with death paralyzes the PC with fear for 1d6 rounds." },
		{ r1 = 19, r2 = 19, text = "The wound immediately turns a deep yellow color and a dizzying madness infects the character. He tem- porarily loses 1d6 Intelligence and 1d6 Personality." },
		...
		{ r1 = 23, r2 = 23, text = "The un-dead s intensely concentrated aura of unholiness infects the PC with an unholy aura. Any magi- cal blessings or similar effects are automatically cancelled, and the character takes 1d4 points of temporary Personality loss." },
	...
	["DN"] = {
		...
		{ r1 = 12, r2 = 12, text = "Luck burn. The touch of the demon brings bad luck upon the character! He loses 1 point of Luck. A half- ling or thief can recover this loss through normal class means." },
		{ r1 = 13, r2 = 13, text = "Severe soul wound. The character loses 3 XP from the demon s soul-searing touch." },
		{ r1 = 14, r2 = 14, text = "Astral drift. The character s soul is sent adrift on the astral plane! The character drops to the ground, cata- tonic, and cannot be revived until his soul is located and returned to his body." },
		...
		{ r1 = 16, r2 = 99, text = "Banishment. The demon s strike banishes the character to the de- mon s home plane! The character vanishes from sight as he is in- stantly transported back to the demon s home. For all intents and purposes, the character is out of the game unless his allies immedi- ately follow to save him." },
		}
	};
