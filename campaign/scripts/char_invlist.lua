...
function onInit()
	...
	DB.addHandler(DB.getPath(node, "*.speedpenalty"), "onUpdate", onArmorChanged);
	DB.addHandler(DB.getPath(node, "*.fumbledie"), "onUpdate", onArmorChanged);
...
function onClose()
	...
	DB.removeHandler(DB.getPath(node, "*.speedpenalty"), "onUpdate", onArmorChanged);
	DB.removeHandler(DB.getPath(node, "*.fumbledie"), "onUpdate", onArmorChanged);
